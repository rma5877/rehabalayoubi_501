...
\\
\noindent \textbf{Office Hours:} Wednesdays 10:00 to 2:00 and by appointment\\\medskip
...
\item Review the articles. Consult the useful documents folder in the Files folder of Canbas. Find the discussion guidelines document. 
...
\item Give a very quick highlight of material covered in the video lecture ($<5$ minutes).
...
presentation (15\%), final repo + writeup (20\%), class benchmarks (5\%).
\end{itemize}
...
\begin{itemize}
\item February 12: Submit two abstracts on Canvas and review the assigned group. 
\item March 5: Submit a one page write up to Canvas and review the assigned group. 
\item April 16: Submit a two page write up to Canvas and review the assigned group. 
\item April 30: Final presentation.
\item May 7: Submit final paper. 
\end{itemize}

\section*{Course Schedule (Spring 2026 --- Thursdays)}
\noindent \textbf{Key dates:} Spring Break week is Mar 8--14 (no class Thu Mar 12). Instructor is traveling Mar 26. You can attend session 1 if you want the material but it is optional. Group presentations are Thu Apr 30. Final paper is due Fri May 1.
...
\item Submit two research abstract ideas for your group paper to Canvas. 
\begin{itemize}
\item Group 1 will review groups 2's ideas.
\item Group 2 will review groups 3's ideas.
\item Group 3 will review groups 4's ideas.
\item Group 4 will review groups 1's ideas.
\end{itemize}
\end{itemize}
...
\item Revise your group presentation ideas. Identify a project you plan to coauthor, a data source, a research question, and lay out an analytic overview (1 page)
\begin{itemize}
\item Group 4 will review groups 2's ideas.
\item Group 3 will review groups 1's ideas.
\item Group 2 will review groups 4's ideas.
\item Group 1 will review groups 3's ideas.
\end{itemize}
\end{itemize}
...
\subsection*{Week 10: March 26, 2026 --- Spatial Data, GIS, and Remote Sensing \textit{Instructor is traveling attendance to the speaker is required. You may attend sessions 1 for the course material}}
\begin{itemize}\compresslist
...
\item Revise your group presentation ideas. Write your introduction and find ten articles from top field journals to center your literature review and theory. This should be two pages total. 
\begin{itemize}
\item Group 4 will review groups 1's ideas.
\item Group 3 will review groups 4's ideas.
\item Group 2 will review groups 3's ideas.
...
\begin{itemize}\compresslist
\item You will coauthor the paper with your group. 
