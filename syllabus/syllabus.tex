...
\subsection*{Week 1: January 15, 2026 --- Course Overview \& What is ``Big Social Data''?}
\begin{itemize}\compresslist
...
\subsection*{Week 2: January 22, 2026 --- The Web as Data (Scraping \& HTML)}
\begin{itemize}\compresslist
...
\subsection*{Week 3: January 29, 2026 --- APIs, Rate Limits, and Data Collection at Scale}
\begin{itemize}\compresslist
...
\subsection*{Week 4: February 5, 2026 --- Surveys, Platforms, and Crowdsourcing}
\begin{itemize}\compresslist
...
\subsection*{Week 5: February 12, 2026 --- Databases \& SQL for Social Data}
\begin{itemize}\compresslist
...
\subsection*{Week 6: February 19, 2026 --- Record Linkage and Entity Resolution}
\begin{itemize}\compresslist
...
\subsection*{Week 7: February 26, 2026 --- Text as Data Pipelines}
\begin{itemize}\compresslist
...
\subsection*{Week 8: March 5, 2026 --- Network Data \& Graph Workflows}
\begin{itemize}\compresslist
...
\subsection*{March 12, 2026 --- \textit{No Class (Spring Break Week)}} 

\subsection*{Week 9: March 19, 2026 --- Spatial Data, GIS, and Remote Sensing}
\begin{itemize}\compresslist
...
\subsection*{Week 10: March 26, 2026 --- Reproducibility: Git, Containers, and Research Artifacts}
\begin{itemize}\compresslist
...
\subsection*{Week 11: April 2, 2026 --- Data Quality, Labeling, and Validation}
\begin{itemize}\compresslist
...
\subsection*{Week 12: April 9, 2026 --- LLM-Assisted Data Extraction (Human-in-the-Loop)}
\begin{itemize}\compresslist
...
\subsection*{Week 13: April 16, 2026 --- RCTs and Large Experiments (Design + Implementation at Scale)}
\begin{itemize}\compresslist
...
\end{itemize}
\subsection*{Week 14: April 23, 2026 --- Time Series Analyses for Social Data}
\begin{itemize}\compresslist
