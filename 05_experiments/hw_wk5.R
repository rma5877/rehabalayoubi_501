...
# Complete sequential workflow (no user-defined functions; explicit steps)
# Includes:
# (Q4) retention outcomes + ATE saved to outputs/tables/ate_retention.csv
# (Q5) noncompliance + ITT vs TOT (IV) saved to outputs/tables/itt_vs_tot.csv
...
###############################################
# Notes for write-up (Q5 explanation):
# - ITT is diluted by noncompliance because some assigned-treated units do not receive.
# - TOT/LATE (IV) recovers the effect among compliers by scaling through the first stage.
###############################################
```
